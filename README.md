# project-aws-2layer-infrastructure : Blog Page Application (Django) deployed on AWS Application Load Balancer with Auto Scaling, S3, Relational Database Service(RDS), VPC's Components, Lambda, DynamoDB and Cloudfront with Route 53
...
![Phonebook App Search Page](./infrastructure.jpg)
...
In the architecture, you can configure your infrastructure using the followings,
  ...
  - The Launch Template should be configured to;
    ...
    - Download the "project-aws-2layer-infrastructure" folder from Github repository,

    - Install the requirements using requirements.txt in 'project-aws-2layer-infrastructure' folder
    ...
    - Instance launched should be tagged `project-aws-2layer-infrastructure`
...
```text
project-aws-2layer-infrastructure (folder)
...
- Step 5: Download or clone project definition from `ompayat` repo on Github 
